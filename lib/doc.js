      ...
      return [
        {
          ...
          label: "Plan",
          variant: "primary",
          message: `Create an implementation plan from this spec: ${file}. Use the superpowers:writing-plans skill. Write the plan HTML to ~/docs/paperflow/plans/ using the article-style template + the shared /paperflow/_lib/doc.{css,js} for buttons. Use ~/.local/bin/paperflow-target to embed the right CLAUDE_TARGET.`
        },
        {
          id: "grill",
          label: "Grill",
          variant: "secondary",
          message: `Grill this spec: ${file}. Use the grill-plan skill — read it in full, generate 8–15 pointed questions with rationale + recommendation + diagram per question, write the grill HTML to ~/docs/paperflow/grills/ using the shared renderer.`
        },
        {
          id: "pdf",
          type: "print",
